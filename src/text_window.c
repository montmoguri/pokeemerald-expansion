...
const u8 gTextWindowFrame1_Gfx[] = INCBIN_U8("graphics/text_window/swsh/1.4bpp");
...
const u16 gTextWindowFrame1_Pal[] = INCBIN_U16("graphics/text_window/swsh/1.gbapal");
