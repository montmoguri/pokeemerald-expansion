...
const u32 gStatusGfxSwSh_Icons[] = INCGFX_U32("graphics/interface/swsh/status_icons.png", ".4bpp.smol");
const u16 gStatusPalSwSh_Icons[] = INCGFX_U16("graphics/interface/swsh/status_icons.png", ".gbapal");
