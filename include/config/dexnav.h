...
#define DN_VAR_SPECIES                FLAG_DEXNAV_VAR_SPECIES // Registered DexNav species
#define DN_VAR_STEP_COUNTER           FLAG_DEXNAV_VAR_STEP_COUNTER // Steps for finding hidden pokemon
